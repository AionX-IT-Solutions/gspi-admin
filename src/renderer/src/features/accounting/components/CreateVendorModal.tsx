...
export function CreateVendorModal({ open, onOpenChange }: CreateVendorModalProps) {
  const { t } = useTranslation()
  const { form, setForm, handleCreate, resetForm } = useCreateVendorModal(onOpenChange)
